 ...
 */
@Slf4j
public class ImageCaptchaValidator extends AbstractCaptchaValidator {

    private final DefaultCommonValidator validator;

    public ImageCaptchaValidator(CaptchaRepository captchaRepository,
    ...
    public void validate(ServletWebRequest request) {
        ...
        log.debug("地址[{}]的图形验证码校验通过.", request.getRequest().getRequestURI());
    }
}