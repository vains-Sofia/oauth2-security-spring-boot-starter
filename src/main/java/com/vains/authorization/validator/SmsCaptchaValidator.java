 ...
 */
@Slf4j
public class SmsCaptchaValidator extends AbstractCaptchaValidator {

    private final DefaultCommonValidator validator;

    public SmsCaptchaValidator(CaptchaRepository captchaRepository,
    ...
    public void validate(ServletWebRequest request) {
        ...
        log.debug("地址[{}]的短信验证码校验通过.", request.getRequest().getRequestURI());
    }
